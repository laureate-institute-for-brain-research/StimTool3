...
image_file = open('DSR_selected_split.csv', 'r')


#list of list of lists--set:block:image
neutral_images = [[[], [], [], [], [], []], [[], [], [], [], [], []], [[], [], [], [], [], []], [[], [], [], [], [], []]]
opioid_images = [[[], [], [], [], [], []], [[], [], [], [], [], []], [[], [], [], [], [], []], [[], [], [], [], [], []]]
stress_images = [[[], [], [], [], [], []], [[], [], [], [], [], []], [[], [], [], [], [], []], [[], [], [], [], [], []]]
...
for l in image_file.readlines()[1:]: #skip header line, build lists of images
   ...
   if this_line[64] == 'stress':
      image_fullpath = stress_path + fname
      stress_images[run][category].append(image_fullpath)
...
def generate_one(neutral_images, drug_images, output_name):
   ...
   for i in range(0,4): #four blocks, alternating between neutral and drug blocks
      ...
      neutral_lines.append('009,media\\stress\\urge_question.PNG,5,')
      ...
      shuffle(drug_lines)
      drug_lines.append('019,media\\stress\\urge_question.PNG,5,')
...
generate_one(neutral_images[0], stress_images[0], 'DCR_R1_METH.schedule')
generate_one(neutral_images[1], stress_images[1], 'DCR_R2_METH.schedule')
generate_one(neutral_images[2], stress_images[2], 'DCR_R3_METH.schedule')
